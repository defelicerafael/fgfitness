...
$smtpUsuario = "info@hamburguesasleblon.com.ar";  // Mi cuenta de correo
$smtpClave = "H4mburgu3s4s";  // Mi contraseña

$cuerpo = "Hola Ato, a llegado un mensaje v&iacute;a web :) \n\n";
...
$mail->AddReplyTo("info@hamburguesasleblon.com.ar"); // Esto es para que al recibir el correo y poner Responder, lo haga a la cuenta del visitante. 
