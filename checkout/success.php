...
$smtpUsuario = "admin@maccingames.com.ar";  // Mi cuenta de correo
$smtpClave = "M4cc1ng4m3s";  // Mi contraseña

$cuerpo = "Hola Rafu, a llegado la notificaci�n de VENTA DE MERCADO PAGO :) \n\n";
$cuerpo .= "EL PAGO A SIDO ACREDITADO! \n\n";
$cuerpo .= "SU ID ES: ".$collection_id."\n\n";
$cuerpo .= "SE PAGO POR MEDIO DE: ".$payment_type."\n\n";
$cuerpo .= "SE PAGARO ESTOS ITEMS:";
foreach($_SESSION['articulos'] as $ak=>$av){
    $cuerpo.= "ID: ".$av['item_id']."\n";
    $cuerpo.= "NOMBRE: ".$av['item_nombre']."\n";
    $cuerpo.= "CANTIDAD: ".$av['item_cantidad']."\n";
    $cuerpo.= "PRECIO: ".$av['item_precio']."\n\n";
}
$cuerpo .= "VAMOS TODAV�A :)";
...
$mail->AddAddress("info@maccingames.com.ar"); 
                    //$mail->AddAddress($emailMili);
                    //$mail->AddAddress($emailJuli);// Esta es la dirección a donde enviamos los datos del formulario
$mail->AddReplyTo("admin@maccingames.com.ar"); // Esto es para que al recibir el correo y poner Responder, lo haga a la cuenta del visitante. 
